...
var file_runner_proto_runner_proto_depIdxs = []int32{
	1, // 0: proto.ConfigureRequest.config:type_name -> proto.Config
	0, // 1: proto.EvalResponse.status:type_name -> proto.ExecutionStatus
	2, // 2: proto.Runner.Configure:input_type -> proto.ConfigureRequest
	4, // 3: proto.Runner.Eval:input_type -> proto.EvalRequest
	3, // 4: proto.Runner.Configure:output_type -> proto.ConfigureResponse
	5, // 5: proto.Runner.Eval:output_type -> proto.EvalResponse
